package io.ddaaniel.listener.internal.support.serializer;
...
import io.ddaaniel.listener.internal.support.serializer.converters.ByteMessageConverter;
import io.ddaaniel.listener.internal.support.serializer.converters.InputStreamMessageConverter;
import io.ddaaniel.listener.internal.support.serializer.converters.JsonMessageConverter;
import io.ddaaniel.listener.internal.support.serializer.converters.StringMessageSerializer;
...
public class SerializationManager {
    ...
    public SerializedResult convert(Object body, String contentType) throws IOException {
        if (body == null) {
            return new SerializedResult(null, null);
        }
	...
	public record SerializedResult(byte[] data, String contentType) {
		...
		public boolean hasContent() {
			return contentType != null && hasBody();
		}

		public Optional<String> optionalContentType() {
